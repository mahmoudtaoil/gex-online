...
export default async function ServicePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div dir="rtl" style={{ minHeight: '100vh', background: '#020617', color: '#fff', position: 'relative' }}>
      ...
      <main style={{ position: 'relative', zIndex: 10, maxWidth: 1100, margin: '0 auto', padding: '40px 20px', display: 'grid', gridTemplateColumns: '1fr 340px', gap: 28 }}>
        <div>
          ...
          <div style={{ display: 'grid', gap: 12 }}>
            {activePackages.map((pkg:any, idx:number) => {
              ...
              return (
                <div key={idx} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '15px 18px', background: 'rgba(15,23,42,0.78)', border: '1px solid rgba(148,163,184,0.14)', borderRadius: 12, backdropFilter: 'blur(8px)' }}>
        ...
        <div style={{ position: 'sticky', top: 90, background: 'rgba(15,23,42,0.85)', border: '1px solid rgba(148,163,184,0.15)', borderRadius: 16, padding: 20, textAlign: 'center', backdropFilter: 'blur(12px)' }}>
